# 🎬 Aplicación Web de Gestión de Películas y Series

Proyecto desarrollados con arquitectura desacoplada (Full-Stack).
...
## 🌐 Enlaces Públicos
* **Frontend:** [Ver App en Netlify](https://tu-app.netlify.app)
